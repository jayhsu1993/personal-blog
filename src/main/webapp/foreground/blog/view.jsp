...
<script type="text/javascript">
    ...
    function submitData(){
    	...
    	if(content==null||content==""){
    		...
    		$.post("${pageContext.request.contextPath}/comment/save.do",{"content":content,"imageCode":imageCode,"blog.id":"${blog.id}"},
    		function(result){
    			if(result.success){
...
<div class="data_list">
  ...
  <div class="blog_title"><h3><strong>${blog.title }
  </strong></h3></div>
  <div class="blog_share">
	<div class="bshare-custom"><a title="分享到QQ空间" class="bshare-qzone"></a><a title="分享到新浪微博" class="bshare-sinaminiblog"></a><a title="分享到人人网" class="bshare-renren"></a><a title="分享到腾讯微博" class="bshare-qqmb"></a><a title="分享到网易微博" class="bshare-neteasemb"></a>
    ...
    <c:choose>
       ...
       <c:otherwise>
          <c:forEach var="key" items="${keyWords }">
             &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/blog/q.html?q=${key }" target="_blank">${key }</a>&nbsp;&nbsp;
          </c:forEach>
       </c:otherwise>
    </c:choose>
  </div>
...
<div class="data_list">
  ...
  <div class="commentDatas">
     <c:choose>
       ...
       <c:otherwise>
         <c:forEach var="comment" items="${commentList }" varStatus="status"><!-- varStatus获得从0开始的索引 -->
           <c:choose>
...
<div class="data_list">
  <div class="data_list_title">
    <img src="/static/images/comment_icon.png"/>发表评论
  </div>
  <div class="publish_comment">
			...
			<div class="verCode">
				验证码：<input type="text" value="" name="imageCode"  id="imageCode" size="10" onkeydown= "if(event.keyCode==13)form1.submit()"/>
