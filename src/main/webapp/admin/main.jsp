...
<div region="south" style="height: 25px;padding: 5px" align="center">
    ...
    <form id="fm" method="post">
      <table cellspacing="8px">
        <tr>
          <td>用户名</td>
          <td>
            <input type="text" id="userName" name="userName" class="easyui-validatebox" required="true" value="${currentUser.userName }" readonly="readonly"/>
          </td>
        </tr>
        <tr>
          <td>新密码</td>
  ...
  <div id="dlg-buttons">
    <a href="javascript:modifyPassword()" class="easyui-linkbutton" iconCls="icon-ok" plain="true">确认</a>
    <a href="javascript:closePasswordModifyDialog()" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">取消</a>
  </div>
</body>
</html>