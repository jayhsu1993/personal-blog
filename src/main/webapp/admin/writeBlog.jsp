...
<script type="text/javascript">
  function submitData(){
	  ...
	  if(title==null||title==''){
		  ...
		  $.post("${pageContext.request.contextPath}/admin/blog/save.do",{'title':title,'blogType.id':blogTypeId,'content':content,
...
<div id="p" class="easyui-panel" title="编写博客" style="padding:10px">
   <table cellspacing="20px">
     <tr>
       ...
       <td><input id="title" name="title" type="text" style="width:400px"/></td>
     </tr>
     <tr>
       <td>所属类别:</td>
       <td>
