...
<script type="text/javascript">
   ...
   function openLinkModifyDialog(){
	  ...
	  if(selectedRows.length!=1){
		  $.messager.alert("系统提示","请选择一个你要修改的友情链接");
		  return;
	  }
...
<body style="margin: 1px;">
  ...
  <div id="dlg-buttons">
    <a href="javascript:saveLink()" class="easyui-linkbutton" iconCls="icon-ok" plain="true">确认</a>
    <a href="javascript:closeLinkDialog()" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">取消</a>
  </div>
</body>
</html>