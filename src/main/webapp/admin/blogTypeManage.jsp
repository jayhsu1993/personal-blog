...
<script type="text/javascript">
   ...
   function openBlogTypeModifyDialog(){
	  ...
	  if(selectedRows.length!=1){
		  $.messager.alert("系统提示","请选择一个你要修改的博客类别");
		  return;
	  }
...
<body style="margin: 1px;">
  ...
  <div id="dlg-buttons">
    <a href="javascript:saveBlogType()" class="easyui-linkbutton" iconCls="icon-ok" plain="true">确认</a>
    <a href="javascript:closeBlogTypeDialog()" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">取消</a>
  </div>
</body>
</html>